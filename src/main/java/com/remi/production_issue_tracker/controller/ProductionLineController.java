...
public class ProductionLineController {
    ...
    @PostMapping
    public ProductionLine createProductionLine(@Valid @RequestBody ProductionLine productionLine)
    { return productionLineService.createProductionLine(productionLine); }

    @PutMapping("/{id}")
    public ProductionLine updateProductionLine(@PathVariable Long id, @Valid @RequestBody ProductionLine productionLine)
